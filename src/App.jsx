      ...
      const renderDashboard = () => {
        switch (profile.role) {
          ...
          case 'CLINIC_ADMIN':
            ...
            return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-purple-50 to-blue-50">Carregando dados da clínica...</div>;
          case 'DOCTOR':
      ...
      return (
        <>
          <Helmet>
            ...
            <meta name="description" content="Sistema SaaS multi-tenant para gestão completa de clínicas médicas" />
          </Helmet>
          {renderDashboard()}
          <Toaster />
        </>
